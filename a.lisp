  ...
  ;Function definition
      (cond
          ...
          (T (let* (
                      ...
                      (sp1 (cond 
                              ((and (equal 0 (remainder div1)) (= 0 (second div2)) (not (equal fac1 fac2))) (first (divide (quotient div1) fac2))) 
                                ((equal 0 (remainder div1)) (quotient div1))
                                ((equal 0 (remainder div2)) (quotient div2))
                                (T spl))
                      )
                      (result (linear-factorize-loop sp1 a_0 a_n (+ b_0 1) b_1))
                      (res1 (if (equal 0 (remainder div1)) (list fac1) NIL))
                      ;(res2 (if (or (= 0 b_0) (not (equal 0 (remainder div2)))) res1 (append res1 (list fac2))))
                      (res2 (if (or (not (equal 0 (remainder div2)))) res1 (append res1 (list fac2))))
                    )
      ...
      (cond
        ...
        (T 
              (let* (
                      ...
                      (sp1 (if (equal 0 (remainder div1)) (quotient div1) spl))
                      (sp2 (if (and (not (equal fac1 fac2)) (equal 0 (remainder div2))) (quotient (divide sp1 fac2)) sp1 ))
                      (sp3 (if (and (not (equal fac1 fac3)) (not (equal fac2 fac3)) (equal 0 (remainder div3))) (quotient (divide sp2 fac3)) sp2))
                      (sp4 (if (and (not (equal fac1 fac4)) (not (equal fac2 fac4)) (not (equal fac3 fac4)) (equal 0 (remainder div4))) (quotient (divide sp3 fac4)) sp3))
                      ;sp4 is not the remaining polynomial after all 4 divisions
                      (result (quadratic-factorize-innerloop sp4 a_0 a_n b_0 b_1 (+ 1 c)))
                      (res1 (if (equal 0 (remainder div1)) (list fac1) NIL))
                      (res2 (if (and (not (equal fac1 fac2)) (equal 0 (remainder div2))) (append (list fac2) res1) res1))
                      (res3 (if (and (not (equal fac1 fac3)) (not (equal fac2 fac3)) (equal 0 (remainder div3)))  (append (list fac3) res2) res2))
                      (res4 (if (and (not (equal fac1 fac4)) (not (equal fac2 fac4)) (not (equal fac3 fac4)) (equal 0 (remainder div4)))  (append (list fac4) res3) res3))
